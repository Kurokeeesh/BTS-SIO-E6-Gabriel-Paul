...
<body>
<form method="POST" action="traiter_questions">
<input type="hidden" name="cle" value="<?= htmlspecialchars($_SESSION['cle']) ?>">
...
<p>
	...
	<input type="button" value="Nouveau questionnaire" onclick="self.location.href='home'" />
</p>
</form>
</body>
</html>
