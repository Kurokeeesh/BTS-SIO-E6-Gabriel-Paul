...
<head>
  ...
  <link rel="stylesheet" href="/Public/questionnaires.css" type="text/css">
</head>
<body>
  <form method="POST" action="traiter_questionnaire">
    ...
    <p>
      ...
      <a href="index.php?page=generer_xml" class="button">Générer XML</a>
    </p>
  </form>
</body>
</html>